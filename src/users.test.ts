...
describe('Testing userSetNameV1', () => {
  test('Valid Name', () => {
    const setNameValidator = requestUserSetName(authUser.token, 'Dan', 'Smith', 200);
    expect(setNameValidator).toStrictEqual({});
  });

  test('Invalid Name', () => {
    const authUser = requestAuthRegister('newEmail@gmail.com', 'password1', 'Dan', 'Smith', 200);
    const nameFirst = 'A';
...
describe('Testing userSetEmailV1', () => {
  ...
  test('Invalid Email', () => {
    ...
    requestUserEmail(authUser1.token, 'email@gmail,com', 400);
  });
...
describe('Testing userSetHandleV1', () => {
  test('Valid Handle', () => {
    const setHandleValidator = requestUserHandle(authUser.token, 'dansmith', 200);
